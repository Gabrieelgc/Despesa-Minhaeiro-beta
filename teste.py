    ...
    while True:
        ...
        match(opcao_inicial):
            case '1':
                ...
                x = email_teste.strip()
                senha_teste = input("Digite a senha cadastrada: ").lower()
                y = senha_teste.strip()
                logar_usuario(x, y)
                ...
                while usuario_logado == True:
                    ...
                    if opcao_modulo == '1':
                        ...
                        modulo_usario()
                        opcao_modulo_usuario = input("Escolha uma opção12: ")
                        ...
                        modulo_despesas()
                        opcao_despesas = input("Escolha uma das opções a seguir:")
                        print("1. Alimentação")
                        print("2. Transporte")
                        print("3. Habitacao/moradia")
                        break
                        ...
                        if(opcao_modulo_despesas == 1):
                            ...
                            print("5. Lazer")
                            print("6. Outros")
                            opcoes_despesas = int(input("Escolha uma das opções: "))
                            if (opcao_modulo_despesas == 1):
                                despesa_alimentacao = float(input("Insira um valor:"))
                            elif(opcao_modulo_despesas == 2):
                                despesa_transporte = float(input("Insira um valor:"))
    ...
    "despesaoutros": despesa_outros,
         ...
         '''
            case '2':
                ...
                nome_cadastro_final = nome_cadastro.strip()

                email_cadastro = input("Digite seu email: ").lower()

                email_cadastro_final = email_cadastro.strip()

                idade_cadastro = int(input("Digite a sua idade: "))

                senha_cadastro = input("Digite uma senha de cadastro: ").lower()

                senha_cadastro_final = senha_cadastro.strip()

                criar_usuario(nome_cadastro_final, email_cadastro_final, idade_cadastro, senha_cadastro_final)
